...
function createHTMLTable(items){
    ...
    let htmlRow = ""
    for (let linenumber = 1; linenumber<items.length; linenumber++){    
        // 0 durch 1 ersetzt Die Liste wird leer angezeigt, aber die Liste verschiebt sich/
        ...
        htmlRow = htmlRow + "<tr>"
        for(let k = 1; k< currItems.length; k++){
